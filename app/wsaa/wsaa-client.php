...
define ("CERT", "../Keys/certificado.crt");       # The X.509 certificate in PEM format
define ("PRIVATEKEY", "../Keys/Laravel"); # The private key correspoding to CERT (PEM)
define ("PASSPHRASE", "Laravel"); # The passphrase (if any) to sign
//define ("PROXY_HOST", "10.20.152.112"); # Proxy IP, to reach the Internet
define ("PROXY_HOST", "192.168.0.1"); # Proxy IP, to reach the Internet
